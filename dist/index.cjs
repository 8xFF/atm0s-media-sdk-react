...
var Atm0s = require('@8xff/atm0s-media-js');
var typedEventEmitter = require('@8xff/atm0s-media-js/types/lib/utils/typed-event-emitter');
var logger$1 = require('@8xff/atm0s-media-js/types/lib/utils/logger');
